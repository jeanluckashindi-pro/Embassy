...
export function AmbassadePage({ SiteHeader, SiteFooter }) {
  return (
    <main className="site-shell bg-white dark:bg-[#161717] text-slate-900 dark:text-[#fafad6] min-h-screen">
      ...
      {/* Hero Header */}
      <section className="py-16 bg-blue-900 dark:bg-[#1d1f1f] text-white border-b border-blue-950 dark:border-[#2d2e2e]">
        <div className="container max-w-5xl">
          <Badge variant="gold" className="mb-3">Mission Diplomatique</Badge>
          <h1 className="text-3xl sm:text-5xl font-extrabold text-white dark:text-[#fafad6] tracking-tight leading-tight">
            Ambassade de la République Démocratique du Congo au Burundi
          </h1>
          <p className="mt-4 text-blue-100 dark:text-[#a7a8a8] text-base sm:text-lg max-w-3xl leading-relaxed">
      ...
      <section className="py-16 bg-[#ffffff] dark:bg-[#161717]">
        <div className="container max-w-6xl">
          <div className="text-center max-w-xl mx-auto mb-10">
            ...
            <h2 className="text-3xl font-bold text-slate-900">Dirigeants & Représentation</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {diplomaticLeaders.map((leader) => (
              <Card key={leader.name} className="bg-slate-50 border-slate-200 overflow-hidden group hover:border-blue-400 transition-all shadow-xs">
                ...
                <CardContent className="p-4">
                  <h3 className="font-bold text-sm text-blue-900">{leader.name}</h3>
                  <p className="mt-1 text-[11px] text-slate-500 leading-relaxed">{leader.role}</p>
                </CardContent>
              </Card>
            ))}
          </div>
