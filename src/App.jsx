  ...
  return getApiList(data)
    ...
    .map((item) => {
      ...
      return {
        ...
        source: item.source_name || "Actualité RDC",
        day: dateParts.day,
...
function HomePage() {
  ...
  return (
    <main className="site-shell">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-blue-950 via-blue-900 to-slate-900 text-white overflow-hidden py-16 lg:py-24" aria-label="Accueil">
        ...
        <div className="container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/30 text-xs font-bold tracking-wide backdrop-blur-sm">
                <Sparkles className="h-4 w-4" />
                <span>RÉPUBLIQUE DÉMOCRATIQUE DU CONGO — CHANCELLERIE À BUJUMBURA</span>
              </div>
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <a
                  href="/demandes"
                  className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold text-sm shadow-lg hover:shadow-xl transition-all cursor-pointer"
                >
                  <FileText className="h-4 w-4" />
                  <span>Demander un document consulaire</span>
                </a>

                <a
                  href="/actualites"
                  className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/30 font-semibold text-sm transition-all cursor-pointer backdrop-blur-xs"
                >
              ...
              {/* Information Strip */}
              <div className="pt-6 border-t border-blue-800/80 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-blue-200">
            ...
            >
              <div className="relative p-8 rounded-3xl bg-gradient-to-b from-blue-900/80 to-slate-900/90 border border-blue-700/50 shadow-2xl backdrop-blur-md text-center max-w-sm">
                <div className="h-28 w-28 mx-auto mb-4 p-2 bg-white/10 rounded-2xl flex items-center justify-center border border-white/20">
                  <img src={logoAmbassadeLight} alt="Armoiries RDC" className="h-full object-contain filter drop-shadow-md" />
                </div>
                <h3 className="text-lg font-bold text-white tracking-wide">République Démocratique du Congo</h3>
                <p className="text-xs text-amber-300 font-semibold mt-1">Justice - Paix - Travail</p>
                <div className="mt-4 pt-3 border-t border-blue-800/80 text-[11px] text-blue-200">
      ...
      {/* Ambassador Welcome - Adaptive Theme */}
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-5">
              <Card className="overflow-hidden shadow-md border-[#f6f5f4] dark:border-[#2d2e2e] bg-white dark:bg-[#161717]">
                <div
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-slate-950/90 backdrop-blur-md text-white border border-slate-800">
                    <span className="text-[10px] uppercase font-bold text-amber-400 tracking-wider">Représentation Officielle</span>
            ...
            <div className="lg:col-span-7 space-y-4">
              <Badge variant="gold">Message du Chef de Mission</Badge>
              ...
              <h3 className="text-sm sm:text-base font-semibold text-blue-800 dark:text-blue-400">
                Représentation de la République Démocratique du Congo auprès de la République du Burundi
              </h3>
              <div className="space-y-3 text-slate-600 dark:text-slate-300 text-xs sm:text-sm leading-relaxed pt-1">
                <p>Ce portail rapproche l'administration consulaire des ressortissants congolais, des partenaires institutionnels et du grand public au Burundi.</p>
                <p>Vous y trouverez les informations officielles, les services de chancellerie, les communiqués et les orientations utiles pour préparer vos démarches.</p>
                <p>L'Ambassade demeure mobilisée pour protéger les intérêts de la République Démocratique du Congo, accompagner sa diaspora et renforcer la coopération avec le Burundi.</p>
              </div>

              <div className="pt-4 flex flex-wrap gap-3">
                <a href="/documents">
                  <button className="bg-blue-800 hover:bg-blue-900 dark:bg-blue-700 dark:hover:bg-blue-600 text-white font-bold px-6 py-3 rounded-xl text-xs inline-flex items-center gap-2 transition-colors cursor-pointer shadow-xs">
                    <span>Consulter tous les services</span>
                    <ArrowRight className="h-4 w-4" />
                  </button>
                </a>
                <a href="/contact">
                  <button className="bg-[#ffffff] hover:bg-[#f6f5f4] dark:bg-[#2d2e2e] dark:hover:bg-[#3d3e3e] text-slate-800 dark:text-[#fafad6] font-bold px-6 py-3 rounded-xl text-xs border border-[#f6f5f4] dark:border-[#2d2e2e] inline-flex items-center gap-2 transition-colors cursor-pointer">
        ...
        <div className="container">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-4 p-6 sm:p-8 rounded-2xl bg-blue-900 dark:bg-[#1d1f1f] text-white border border-blue-950 dark:border-[#2d2e2e] shadow-md">
            ...
            <a href="/demandes?type=visa">
              <button className="bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold px-6 py-3.5 rounded-xl text-xs transition-colors cursor-pointer shadow-sm shrink-0">
  ...
  return (
    <main className="site-shell documents-page-shell">
      ...
      <section className="py-12 bg-slate-900 text-white">
        <div className="container">
          <Badge variant="gold" className="mb-3">Services consulaires</Badge>
          <h1 className="text-3xl sm:text-4xl font-bold">Tous les documents de l'Ambassade</h1>
  ...
  return (
    <div className="space-y-6">
      {requerantFieldGroups.map((group) => (
        <Card key={group.title} className="p-5 border-slate-200/80 dark:border-slate-800">
              ...
              <div key={field.name} className={field.wide ? "sm:col-span-2" : ""}>
                ...
                {field.type === "select" ? (
                  <select
                    ...
                    className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs text-slate-900 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
                  >
...
function DynamicDemandeFields({ champs, values, onChange }) {
  ...
  if (!activeChamps.length) {
    return <div className="p-4 text-xs text-slate-500 italic bg-slate-50 dark:bg-slate-800 rounded-xl">Aucun champ spécifique requis pour ce type de demande.</div>;
  }
  ...
  return (
    <div className="space-y-3">
      {requiredDocuments.map((item) => {
        ...
        return (
          <label key={key} className="flex items-center justify-between p-4 rounded-xl border border-dashed border-slate-300 dark:border-slate-700 hover:border-blue-500 bg-slate-50 dark:bg-slate-900/50 cursor-pointer transition-all">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-lg bg-blue-100 dark:bg-blue-950 text-blue-600 flex items-center justify-center shrink-0">
            ...
            <div className="text-right">
              ...
              <Button type="button" variant="outline" size="sm" className="mt-1 h-7 text-xs gap-1">
  ...
  return (
    <main className="site-shell">
      ...
      <section className="py-10 bg-slate-900 text-white">
        <div className="container">
          <Badge variant="gold" className="mb-2">Formulaire consulaire</Badge>
          <h1 className="text-3xl font-bold">{requestTitle}</h1>
          <p className="mt-2 text-sm text-slate-300 max-w-xl">{requestDescription}</p>
        </div>
      </section>
  ...
  return (
    <main className="site-shell">
      <section className="topbar">
        <div className="container topbar-inner">
          <div className="contact-line">
            <span><MapPin size={16} />Bujumbura, Burundi</span>
            <span><Mail size={16} />contact@ambardcbujumbura.cd</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-slate-900 text-white">
        <div className="container">
          ...
          <h1 className="text-3xl font-bold">Contacts de l'Ambassade</h1>
          <p className="mt-2 text-sm text-slate-300">Coordonnées et formulaires de contact direct.</p>
        </div>
      </section>
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="p-6">
            ...
            <form onSubmit={(e) => { e.preventDefault(); toast.success("Message envoyé à l'Ambassade."); }} className="space-y-4">
              <div>
                <label className="text-xs font-semibold mb-1 block">Votre email</label>
                <Input type="email" placeholder="nom@exemple.com" required className="text-xs" />
              </div>
              <div>
                <label className="text-xs font-semibold mb-1 block">Sujet</label>
                <Input type="text" placeholder="Sujet de votre message" required className="text-xs" />
              </div>
              <div>
                <label className="text-xs font-semibold mb-1 block">Message</label>
                <textarea rows={4} className="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 p-3 text-xs focus:ring-2 focus:ring-blue-600" required />
              </div>
          ...
          <Card className="p-6">
            <h3 className="text-lg font-bold mb-2">Audience avec l'Ambassadeur</h3>
            ...
            <form onSubmit={(e) => { e.preventDefault(); toast.success("Demande d'audience soumise."); }} className="space-y-4">
              <div>
                ...
                <Input type="text" placeholder="Nom et prénom" required className="text-xs" />
              </div>
              <div>
              ...
              <div>
                <label className="text-xs font-semibold mb-1 block">Objet de la Rencontre</label>
                <textarea rows={4} className="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 p-3 text-xs focus:ring-2 focus:ring-blue-600" required />
              </div>
      ...
      <section className="py-12">
        <div className="container max-w-2xl">
          <Card className="p-6 text-center space-y-6">
            ...
            <h1 className="text-2xl font-bold">Informations de Paiement</h1>
            <div className="space-y-2 text-left bg-slate-50 dark:bg-slate-800 p-4 rounded-xl text-xs">
              {bankInfo.map((b) => (
                <div key={b.label} className="flex justify-between border-b pb-2 last:border-0">
